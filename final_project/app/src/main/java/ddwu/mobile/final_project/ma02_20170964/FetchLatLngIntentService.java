...
public class FetchLatLngIntentService extends IntentService {   // 주소를 받아오면 위도/경도 반환. Manifest에 등록해야 함.
...
//    ResultReceiver 에게 결과를 Bundle 형태로 전달
    private void deliverResultToReceiver(int resultCode, ArrayList<LatLng> message) {
        Log.d(TAG, "deliverResultToReceiver() 들어옴!");
